        ...
        >
            ...
            <Modal.Body>
                ...
                <Dropdown className="mb-3" style={{margin: "0 auto"}}>
                    ...
                    <Dropdown.Menu>
                        {brandOrType === "Бренд" ? <Dropdown.Item disabled>Бренд</Dropdown.Item> : <Dropdown.Item onClick={() => setBrandOrType("Brand")}>Бренд</Dropdown.Item>}
                        {brandOrType === "Тип" ? <Dropdown.Item disabled>Тип</Dropdown.Item> : <Dropdown.Item onClick={() => setBrandOrType("Type")}>Тип</Dropdown.Item>}
                    </Dropdown.Menu>
                </Dropdown>

                Choose item of {brandOrType === "Бренд" ? "Бренд" : "Тип"}
                <Dropdown className="mb-3" style={{margin: "0 auto"}}>
                    <Dropdown.Toggle variant="success" id="dropdown-basic">
