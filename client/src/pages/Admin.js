    ...
    return (
        <Container className="d-flex flex-column">
            ...
            <Dropdown className="mt-5 mb-3" style={{margin: "0 auto"}}>
                ...
                <Dropdown.Menu>
                    {filter === "Все" ? <Dropdown.Item disabled>All</Dropdown.Item> : <Dropdown.Item onClick={() => setFilter("All")}>All</Dropdown.Item>}
                    {filter === "Без типа или бренда" ? <Dropdown.Item disabled>Без типа или бренда</Dropdown.Item> : <Dropdown.Item onClick={() => setFilter("Без бренда типа")}>Без бренда типа</Dropdown.Item>}
                </Dropdown.Menu>
            </Dropdown>
